...
import int101s2023h01.src.main.java.int101.work03.MyUtil;
import int101s2023h01.src.main.java.int101.work04.BankAccount;
import int101s2023h01.src.main.java.int101.work04.Person;
...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
      ...
      */
       System.out.println("CalculateBMI : "+ MyUtil.calculateBMI(50,1.70));
       System.out.println("CalculateAverage : "+ MyUtil.average(5,6,7) + "\n");
   }
   ...
   static void work04UseOfObjectClass() {
      ...
      */
       Person jatta = new Person(1);
       Person natiphong = new Person(2);
       System.out.println(jatta);
       System.out.println("setID : from 2 to 494949");
       jatta.setId(494949);
       System.out.println(jatta + "\n");

       BankAccount scbOfJetta = new BankAccount(434343, jatta);
       BankAccount nextOfNatiphong = new BankAccount(54543, natiphong);
       System.out.println(scbOfJetta);
       System.out.println(nextOfNatiphong + "\n");

       System.out.println("Deposit : 3000$");
       scbOfJetta.deposit(3000);
       System.out.println(scbOfJetta);
       System.out.println("Withdraw : 500$");
       scbOfJetta.withdrew(500);
       System.out.println(scbOfJetta + "\n");

       System.out.println("Transfer : SCBJETTA to NextNATIPHONG : 300$");
       scbOfJetta.transfer(300,nextOfNatiphong);
       System.out.println(scbOfJetta);
       System.out.println(nextOfNatiphong);

//       System.out.println(scbOfJetta.toString());
//       System.out.println(nextOfNatiphong.toString());
